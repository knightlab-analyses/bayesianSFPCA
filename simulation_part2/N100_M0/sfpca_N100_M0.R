...
load("sim_N100_M0.RData", dat <- new.env())
#ls.str(dat) 
...
save(df, file='simulated_data_N100_M0_wide.rData')
...
save(sa.list,log_lik.list,looic.list,file="sfpca_results_N100_M0.RData")
...
save(alpha_new, theta_mu_new, Theta_new, results_basis, prepared_data, 
	 file="estimates_N100_M0.RData")


######### plot sfpca results ######
load('estimates_N100_M0.RData')
