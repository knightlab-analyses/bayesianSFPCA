############################################################################
### generate simulated data with 100 total samples and 80% missing data ####
############################################################################
...
save(file="sim_N100_M80.RData",TIME_SPARSE,Y_SPARSE,MU_SPARSE,F_SPARSE,OMEGA_SPARSE,ALPHA,params,knots,time, phi_t)
