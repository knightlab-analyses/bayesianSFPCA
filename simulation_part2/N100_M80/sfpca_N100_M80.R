...
load("sim_N100_M80.RData", dat <- new.env())
#ls.str(dat) 
...
save(df, file='simulated_data_N100_M80_wide.rData')
...
save(sa.list,log_lik.list,looic.list,file="sfpca_results_N100_M80.RData")

##################### sfpca results ##############
load('sfpca_results_N100_M80.RData')
sa = sa.list
...
save(alpha_new, theta_mu_new, Theta_new, results_basis, prepared_data, 
	 file="estimates_N100_M80.RData")

######### plot sfpca results ######
load('estimates_N100_M80.RData')	
