...
load("sim_N10_M50.RData", dat <- new.env())
#ls.str(dat) 
...
save(df, file='simulated_data_N10_M50.rData')
...
save(sa.list,log_lik.list,looic.list,file="sfpca_results_N10_M50.RData")

##################### sfpca results ##############
load('sfpca_results_N10_M50.RData')
sa = sa.list
