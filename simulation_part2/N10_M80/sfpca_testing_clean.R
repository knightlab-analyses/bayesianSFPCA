...
, , 1
            ...
            [,1]        [,2]
[1,]  0.06447085  0.02555412
[2,] -0.55193555 -0.69836921
[3,] -0.66407567 -0.54368018
[4,] -0.61800777 -0.57817236
[5,] -0.56144280 -0.58739351
[6,] -0.57910185 -0.67500520

, , 2

            [,1]        [,2]
[1,]  0.52300422  0.51935609
[2,] -0.06043856  0.34974198
[3,] -0.39955344 -0.05947264
[4,] -0.40572956  0.07658717
[5,] -0.30191543 -0.06166928
[6,] -0.07989630  0.04536724

, , 3

          [,1]      [,2]
[1,] 0.8160537 0.8804240
[2,] 0.5745114 0.8520712
[3,] 0.5110282 0.6171560
[4,] 0.4647951 0.5879148
[5,] 0.6099589 0.5594574
[6,] 0.5534739 0.6701784
...
, , 1
          ...
          [,1]      [,2]      [,3]      [,4]      [,5]      [,6]       [,7]
[1,] -2.462827 -3.710587 -4.608417 -2.070535 -1.556584 -1.683923 -0.8495834
[2,] -1.534953 -1.775270 -2.680820 -1.536774 -1.238904 -1.765079 -0.9503625
          [,8]      [,9]      [,10]
[1,] -1.972734 -1.311624 -1.0455091
[2,] -1.881429 -1.253735 -0.9191325

, , 2

            [,1]      [,2]        [,3]       [,4]       [,5]       [,6]      [,7]
[1,] -0.84853748 2.4878211 -2.37661937 -0.6417012 -0.1554318  0.4299754 0.6827245
[2,] -0.00724006 0.3788882  0.01342098 -0.4758229 -0.2145162 -0.7562569 0.5840025
           [,8]      [,9]     [,10]
[1,] -0.7144063 0.6599263 0.8464749
[2,] -0.3059008 0.2221341 0.3667062

, , 3

         [,1]     [,2]     [,3]      [,4]      [,5]     [,6]     [,7]      [,8]
[1,] 1.484799 4.124055 3.340761 0.8364266 0.9821293 2.928015 2.195293 0.6771964
[2,] 1.352390 2.827262 2.112842 0.6436495 1.0898296 1.586133 1.951879 0.9117611
         [,9]    [,10]
[1,] 2.052344 2.258250
[2,] 1.666318 1.329861
...
dat$ALPHA[[1]][3:4, 1:10] ########
          ...
          [,1]      [,2]      [,3]       [,4]      [,5]       [,6]       [,7]
[1,] 1.0309333 -2.299502 2.7141492  0.7872993 0.4118890 -0.6381551 -0.1848142
[2,] 0.3242451  1.564245 0.9633147 -1.1088259 0.1076394 -0.5230659  0.7610567
           [,8]       [,9]      [,10]
[1,]  0.5406682 -0.6753069 -0.5551587
[2,] -1.2197474  0.5941594  0.6664801
...
(Intercept)  -0.7313     0.1216  -6.016 1.75e-06 ***
df$groupG2    1.4796     0.1719   8.606 2.37e-09 ***
...
Coefficients:
            Estimate Std. Error t value Pr(>|t|)   
(Intercept) -0.21142    0.08224  -2.571  0.01576 * 
df$groupG2   0.38532    0.11631   3.313  0.00255 **
